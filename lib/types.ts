...
export type SubscriptionStatus = "active" | "past_due" | "canceled" | "trialing" | "expired" | "locked"
...
export interface Family {
  ...
  trialStartedAt?: Date
  trialEndsAt?: Date
  trialEndedAt?: Date // When the trial actually ended (could be early if they subscribed)
  // Account status
  accountStatus?: "active" | "trial" | "expired" | "locked" | "deleted"
  accountLockedAt?: Date // When account was locked due to non-payment
  scheduledDeletionAt?: Date // 30 days after lock, data will be deleted
}
